#
#  Be sure to run `pod spec lint MDPodSpec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "kuaichuan" => "www.kuaichuan888@163.com" }
  # Or just: s.author    = "kuaichuan"
  # s.authors            = { "kuaichuan" => "" }
  # s.social_media_url   = "http://twitter.com/kuaichuan"
